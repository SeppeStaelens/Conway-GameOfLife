...
class Array1D {
 public:
  ...
  //! @param shift The shift with which the array to be copied is loaded in the
  //! current array. If non-zero, arr needs to be smaller than the current
  //! array.
  ...
  //! @param arr The array from which the data is to be copied. Accessed by
  //! reference.
