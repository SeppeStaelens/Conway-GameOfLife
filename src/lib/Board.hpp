    ...
    public:
        ...
        */
        ...
        void update_board(){
            ...
            // Start with the top row, which requires the neighbours of the upper ghost row
            ...
            // Finally the bottom row, which requires the neighbours of the bottom ghost row
            temp1.copy_into(&temp2);
            temp2.copy_into(&temp3);
